    ...
    SweetAlert.prototype.init = function () {
        ...
        $('#sa-image').click(function () {
            Swal.fire({
                ...
                imageUrl: "../static/assets/images/users/profile.png"
            });
        });
        ...
        $("#sa-bg").click(function () {
            Swal.fire({
                ...
                width: 600,
                padding: '3em',
                background: '#fff url(../static/assets/images/background/active-bg.png)',
                backdrop: `
                        rgba(0,0,123,0.4)
                        url("../static/assets/images/background/nyan-cat.gif")
                        center left
                        no-repeat
                    `
            })
